                ...
                <form autoComplete="off" onSubmit={sendData}>
                    <div className="userSignup_align">
                        ...
                        <div style={{ margin: "5px", textAlign: "left" }}>
                            ...
                            <TextField id="outlined-basic" type='password' value={password} onChange={handlePasswordChange} error={Boolean(passwordError)} helperText={passwordError} label="Password" variant="outlined" className="userSignup_textbox" InputLabelProps={{ style: { color: 'grey' } }} />
                        </div>
                        {/* <div style={{ margin: "5px", textAlign: "left" }}>
